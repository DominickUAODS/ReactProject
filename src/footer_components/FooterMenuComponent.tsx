...
const FooterMenuComponent: React.FC<CategoryListProps> = ({ title, links }) => {
	...
	return (
		<div className={`category-list ${isOpen ? 'open' : ''}`}>
			<div className="footer__heading text-medium mb-3" onClick={toggleOpen}>
				{title}
			</div>
			<nav>
...
export const InformationComponent: React.FC = () => {
	...
	return (
		<div className="info-block">
			...
			<div className={`footer__contact-information ${isOpen ? 'open' : ''}`}>
				...
				<ul className="list-unstyled d-flex mb-0 test">
					<li className="mb-0">
						<a href="https://www.facebook.com/JYSK.UA" target="_blank" rel="noreferrer" className="d-inline-block p-2">
							<img role="img" aria-hidden="true" width="30" height="30" aria-label="" src="src/assets/img/facebooklogo.png" />
						</a>
					</li>
					<li className="mb-0">
						<a href="https://www.instagram.com/jyskua/" target="_blank" rel="noreferrer" className="d-inline-block p-2">
							<img role="img" aria-hidden="true" width="30" height="30" aria-label="" src="src/assets/img/instlogo.png" />
						</a>
					</li>
					<li className="mb-0">
						<a href="https://t.me/JYSK_ua" target="_blank" rel="noreferrer" className="d-inline-block p-2">
							<img role="img" aria-hidden="true" width="30" height="30" aria-label="" src="src/assets/img/tglogo.png" />
						</a>
					</li>
					<li className="mb-0">
						<a href="https://www.youtube.com/user/JYSKUA" target="_blank" rel="noreferrer" className="d-inline-block p-2">
							<img role="img" aria-hidden="true" width="30" height="30" aria-label="" src="src/assets/img/youtubelogo.png" />
						</a>
					</li>
				</ul>
			</div>
